...
/**
 * This validator takes care of validating the edittext. The input will be valid only if the number is a valid credit
 * card.
 * 
...
public class CreditCardValidator extends Validator {
    ...
    public CreditCardValidator(String customErrorMessage) {
